...
based on [TypeScript Template Data Source for Grafana](https://github.com/grafana/typescript-template-datasource) and [SimpleJson Datasource](https://github.com/grafana/simple-json-datasource)
