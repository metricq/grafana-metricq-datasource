...
/*!**************************!*\
  !*** ./ConfigEditor.tsx ***!
  \**************************/
/*! exports provided: MetricQConfigEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MetricQConfigEditor", function() { return MetricQConfigEditor; });
...
var MetricQConfigEditor =
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(MetricQConfigEditor, _super);

  function MetricQConfigEditor() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.onConfigChange = function (config) {
      var _a = _this.props,
          onOptionsChange = _a.onOptionsChange,
          options = _a.options;
      onOptionsChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, options), config));
    };

    return _this;
  }

  MetricQConfigEditor.prototype.render = function () {
...
/*!*************************!*\
  !*** ./QueryEditor.tsx ***!
  \*************************/
/*! exports provided: MetricQQueryEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MetricQQueryEditor", function() { return MetricQQueryEditor; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
...
var MetricQQueryEditor =
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(MetricQQueryEditor, _super);

  function MetricQQueryEditor(props) {
    ...
    _this.onFunctionsChange = function (value) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query,
          onRunQuery = _a.onRunQuery;
      onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
        functions: value.map(function (val) {
          return val.value;
        })
      }));
      onRunQuery();
    ...
    _this.onSmaWindowChange = function (event) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query,
          onRunQuery = _a.onRunQuery;
      onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
        smaWindow: event.target.value
      }));
      onRunQuery();
    };
    ...
    _this.onRawMetricChange = function (event) {
      _this.setState({
        rawMetric: event.target.checked
      });
    };

    _this.loadMetricOptions = function (query) {
      var datasource = _this.props.datasource;
      return datasource.metricFindQuery(query || '').then(function (result) {
  ...
  MetricQQueryEditor.prototype.render = function () {
    var _this = this;
    ...
    var name = query.name,
        ...
        smaWindow = query.smaWindow,
        scalingFactor = query.scalingFactor;
    var metricVal = {
      label: metric,
      value: metric
    };
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["InlineFieldRow"], null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["InlineField"], {
    ...
    }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, !this.state.rawMetric && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["AsyncSelect"], {
      isMulti: false,
      isClearable: true,
      allowCustomValue: true,
      backspaceRemovesValue: false,
      onChange: function (selectableValue) {
        return _this.onMetricChange(selectableValue && selectableValue.value || _types__WEBPACK_IMPORTED_MODULE_4__["defaultQuery"].metric);
      },
      ...
      value: metricVal
    }), this.state.rawMetric && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Input"], {
      value: metric,
      onChange: function (event) {
        return _this.onMetricChange(event.target.value);
      },
      ...
      value: this.state.rawMetric,
      onChange: this.onRawMetricChange
      ...
      value: functions
    })), functions.includes('sma') && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["InlineField"], {
      label: "SMA Window",
      labelWidth: labelWidth,
      tooltip: 'Use a duration string, like "10s"'
    }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Input"], {
      value: smaWindow,
      onChange: this.onSmaWindowChange
    }))), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["InlineFieldRow"], null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["InlineField"], {
...
/*!***********************!*\
  !*** ./datasource.ts ***!
  \***********************/
/*! exports provided: MetricQDatasource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MetricQDatasource", function() { return MetricQDatasource; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(MetricQDatasource, _super);

  function MetricQDatasource(instanceSettings) {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.doRequest(this.url + '/query', 'POST', query).then(function (response) {
              return response.data.map(function (result) {
                ...
                result.datapoints.forEach(function (point) {
  ...
  MetricQDatasource.prototype.metricFindQuery = function (query) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        interpolated = {
          target: Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getTemplateSrv"])().replace(query, undefined, 'regex')
        };
        return [2
        /*return*/
        , this.doRequest(this.url + '/search', 'POST', interpolated).then(this.mapToTextValue)];
      });
    });
  };
  ...
  MetricQDatasource.prototype.mapToTextValue = function (result) {
    return lodash__WEBPACK_IMPORTED_MODULE_1___default.a.map(result.data, function (d, i) {
      if (d && d.text && d.value) {
        return {
          text: d.text,
          value: d.value
        };
      } else if (lodash__WEBPACK_IMPORTED_MODULE_1___default.a.isObject(d)) {
        return {
          text: d,
          value: i
        };
  ...
  MetricQDatasource.prototype.doRequest = function (url, method, options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  MetricQDatasource.prototype.buildQueryParameters = function (options) {
    ...
    options.targets = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.filter(options.targets, function (target) {
      return target.metric !== 'select metric';
    });
    options.targets = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.map(options.targets, function (target) {
      target.name = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getTemplateSrv"])().replace(target.name, options.scopedVars, 'regex');
      target.metric = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getTemplateSrv"])().replace(target.metric, options.scopedVars, 'regex');
      return target;
    });
    return options;
  };
...
var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_3__["DataSourcePlugin"](_datasource__WEBPACK_IMPORTED_MODULE_0__["MetricQDatasource"]).setConfigEditor(_ConfigEditor__WEBPACK_IMPORTED_MODULE_2__["MetricQConfigEditor"]).setQueryEditor(_QueryEditor__WEBPACK_IMPORTED_MODULE_1__["MetricQQueryEditor"]);
